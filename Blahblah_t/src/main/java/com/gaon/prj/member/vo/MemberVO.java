...
public class MemberVO {
	...
	private String nickname;		//NICKNAME	VARCHAR2(40 BYTE)	No		3	닉네임
	private String email;			//EMAIL	VARCHAR2(100 BYTE)	No		4	이메일
	...
	private Date cdate;				//CDATE	TIMESTAMP(6)	Yes	"systimestamp "	8	가입일
}