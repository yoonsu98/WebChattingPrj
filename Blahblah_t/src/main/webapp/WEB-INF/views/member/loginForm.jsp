...
<body>
	...
	<div id="FindPassWordPopup" class="modal">
		...
		<div class="modal-content">
			...
			<div class="form-group">
				<label for="EntertheEmail"></label>
				<input type="text" class="form-control" id="EntertheEmail" name="EntertheEmail" placeholder="이메일 입력">
				<div><span id = "email_check"></span></div>
			</div>
			<div>
				<button type="button" onClick="ajaxCallFindPassword();" class="btn btn-default">임시 비밀번호 전송</button>
			</div>
		</div>
